// ignore_for_file: camel_case_types, prefer_final_fields, prefer_const_constructors, unused_element, avoid_print, use_build_context_synchronously, unnecessary_new
...
class peshawar_map extends StatefulWidget {
  const peshawar_map({Key? key}) : super(key: key);

  @override
  State<peshawar_map> createState() => _peshawar_mapState();
}

class _peshawar_mapState extends State<peshawar_map> {
